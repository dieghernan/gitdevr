...
- For bugs, [file an
  issue](https://github.com/dieghernan/gitdevr/issues/new).
...
requests](https://github.com/dieghernan/gitdevr/issues) to make sure the
...
**gitdevr** is maintained by volunteers, so a response may not be
