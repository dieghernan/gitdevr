...
and JS. This means that when **Quarto** introduces new features, **pkgdown** may
lag in supporting them. If you try something that does not work and is not
...
-   **pkgdown** passes the `lang` setting on to **Quarto**, but the available
    languages do not match perfectly. Learn more in
