# Contributing to gitdevr

This guide explains how to propose a change to **gitdevr**. Review the
...
- Fork the package and clone it onto your computer. If you have not done
  this before, use
  `usethis::create_from_github("dieghernan/gitdevr", fork = TRUE)`.
...
Please note that the **gitdevr** project is released with a [Contributor
Code of
Conduct](https://dieghernan.github.io/gitdevr/CODE_OF_CONDUCT.md). By
